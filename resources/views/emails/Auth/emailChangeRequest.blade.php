                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class=""
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            We received a
                                                                            request to change your email for your
                                                                            account with us, your Otp is : {{ $data['otp'] }}</p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 21.6px;">
                                                                            <br />If you did not request a email
                                                                            change, please ignore this email.</p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 21.6px;">
                                                                            </p>
                                                                        <p
                                                                            style="margin: 0; mso-line-height-alt: 21.6px;">
                                                                            If you have any issue in changing your email   please don't hesitate to
